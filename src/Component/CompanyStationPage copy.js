...
function DraggableDriver({ id, driver }) {
                          ...
                          {days.map((day) => {
                            ...
                            return (
                              <td
                                ...
                                className={`${hasUnassigned ? 'not-assigned' : ''} ${activeAssignCell === `${header.id}-${day.id}` ? 'assign-col-active' : ''}`}
                              >
                                ...
                                {hasUnassigned && (
                                  <div className="not-assigned-content">
                                    ...
                                    >
                                      Click to assign<span><i className="fas fa-chevron-down"></i></span>
                                    </a>
                          ...
                          return grouped.map((group, index) => (
                            <td className="draggable-item" key={index}>
                                ...
                                group.map((driver, idx) =>
                                  driver.name ? (
                                    <div className="driver-box routes-box" key={idx}>
                                      ...
                                      <div className="routes-option">
                                        <ul className="routes-edit-option">
                                          <li className="driver-routes-edit">
                                            <a href="#" className="edit-driver-form-btn">
                                              <img src={`${process.env.PUBLIC_URL}/images/edit-2.png`} alt="" />
                                            </a>
                                          </li>
                              ...
                              <div className="add-drivers">
                                <a href="#" className="add-drivers-btn">
                    ...
                    <tbody>
                      {routeHeadersDayWise.map((route) => {
                        ...
                        return (
                          <tr key={route.id} className="dispatch droppable-area1">
                            ...
                            {/* Assigned Employees */}
                            <td className={`table-day-col draggable-item ${!hasAssigned ? 'not-assigned' : ''}`}>
                      ...
                      <tr className="stand-drivers droppable-area1">
                        ...
                        <td className="draggable-item">
                           <DriverTable />
                          <div className="driver-wrapper" style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                            {/* Only render actual drivers here */}
                            {[
                              { name: 'Courtney Henry', role: 'Driver' }
                            ].map((driver, idx) => (
                              <div className="driver-box routes-box" key={idx}>
                        ...
                        <td class="routes-col routes-notes-col">
                          <div class="routes-col-row">
                            <div class="routes-col-content">
                              <h5>Heavy business area</h5><span class="location">Late Pick
                                up</span>
                            </div>
                          </div>
                        </td>
                      ...
                      <div className="edit-shift-content">
                        ...
                        <div className="form-group">
                          ...
                          <textarea id="notes" name="notes"
                            rows="2">About 220 Stop mostly Residential</textarea>
                        </div>
                      </div>
                    </div>
                    <div className="form-footer">
