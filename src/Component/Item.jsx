...
export function Item({ id, label, title, class_type, dragOverlay, onEdit, onAdd }) {
  ...
  const handleAdd = (e) => {
    e.stopPropagation();
    if (onAdd) onAdd(id, label); // trigger add logic
  };

  return (
    <div className={class_type + ' routes-box'}
      ref={setNodeRef}
      {...attributes}
      {...listeners}
      style={style}
        ...
        <div className="routes-option" >
          <ul className="routes-edit-option">
            <li className="routes-edit">
              <a href="#" title="Edit" onClick={handleEdit} onPointerDown={stopDragHandler} className="edit-shift-form-btn">
                <img src={`${process.env.PUBLIC_URL}/images/edit-2.png`} alt="" />
              </a>
            </li>
             <li className="routes-trash">
              <a href="#" title="Delete" onClick={handleDelete} onPointerDown={stopDragHandler}>
                <img src={`${process.env.PUBLIC_URL}/images/trash.png`} alt="" />
              </a>
            </li>
            <li className="routes-add">
              <a href="#" title="Add Employee" onClick={handleAdd} onPointerDown={stopDragHandler} className="create-employee-btn">
